...
(function(html5) {
	var utils = jwplayer.utils,
		...
		ABOUT_DEFAULT = escape("关于视联动力 "),
		LINK_DEFAULT = "http://www.visionvera.com/",
		
		ABOUT_DEFAULT1 = escape("联系电话:010-84187491"),
		LINK_DEFAULT1 = "http://www.visionvera.com/",
	...
	html5.rightclick = function(api, config) {
		var _api = api,
			...
			_config = utils.extend({
				...
				aboutlink1:LINK_DEFAULT1,
				abouttext1:ABOUT_DEFAULT1,
			}, config),
		...
		function _init() {
	        ...
	        _about.innerHTML = unescape(_config.abouttext);
	        _about.onclick = _clickHandler;
	        _menu.appendChild(_about);
	        
	        _about = _createElement(RC_ITEM_CLASS);
	        _about.innerHTML = unescape(_config.abouttext1);
	        _about.onclick = _clickHandler1;
	        _menu.appendChild(_about);
		...
		function _clickHandler1() {
			window.top.location = _config.aboutlink1;
		}
