package com.longtailvideo.jwplayer.media {
	...
	public class VideoMediaProvider extends MediaProvider {
		...
		private function loadStream():void {
			...
			Logger.log("Logo VideoMediaProvider loadStream url = " + url);
		...
		public function onClientData(data:Object):void {
			if (!data) return;
			Logger.log("Logo VideoMediaProvider onClientData data.duration = " + item.duration);
			if (data.width) {
		...
		protected function positionHandler():void {
			//Logger.log("Logo VideoMediaProvider positionHandler ");
