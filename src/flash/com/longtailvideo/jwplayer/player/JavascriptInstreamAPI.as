	...
	public class JavascriptInstreamAPI {
		...
		protected function setupJSListeners():void {
			try {
				...
				ExternalInterface.addCallback("jwInstreamSetDuration", js_setDuration);
		...
		protected function js_setDuration(duration:Number=0):void {
			if (_isPlayer) _isPlayer.setDuration(duration);
		}
